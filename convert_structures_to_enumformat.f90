...
type crystal
   ...
   real(dp) :: gstenergy         ! Energy of the groundstate at this concentration (or the line?)
...
type GA_variables             ! This data type will contain all GApar.in data
   ...
   integer :: nClusters, nAlwaysOn        ! total number of clusters, number of clusters that are always on
...
!
!
! test driver file for converting a given structures.in file to enumformat with
! the help of lat.in
!
! the main concept is taken from find_structure_in_list. 
!
!
