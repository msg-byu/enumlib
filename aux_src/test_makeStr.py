...
class TestMakeStructures(ut.TestCase):
    ...
    def test_str1(self):
        ...
        self._compare_files(
            "vasp.{}".format(args["structures"][0]), "test_files/quaternary_vasp.1"
        )
        system("rm vasp*")
    ...
    def test_str2(self):
        ...
        _make_structures(args)
        self._compare_files(
            "vasp.{}".format(args["structures"][0]), "test_files/quaternary_vasp.2"
        )
        system("rm vasp*")
    ...
    def test_str3(self):
        ...
        _make_structures(args)
        self._compare_files(
            "vasp.{}".format(args["structures"][0]), "test_files/quaternary_vasp.3"
        )
        system("rm vasp*")
