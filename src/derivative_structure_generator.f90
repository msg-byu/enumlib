...
!del    write(*,'("crange orig:")')
!del  do i = 1, size(crange,1)
!del     write(*,'(10(1x,i2))') crange(i,:)
!del  enddo
...
!del                   print*, "site_res", site_res
                   ! ! print*, "max_binomial", max_binomial
                   ! ! print*, "multinomial(iRange(iC,:))", multinomial(iRange(iC,:))
                   ! print*, "arrows",arrows
