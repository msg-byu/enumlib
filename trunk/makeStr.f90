...
integer k, strN, sizeN, nAt, diag(3), a,b,c,d,e,f, HNF(3,3), L(3,3), g(3), istat
...
do 
   ...
   if(dummy=="start") exit
enddo
write(13,'("Found ""start"" label. Now skipping lines to struct #: ",i10)') strN 

! Skip to the specified structure number
do iline = 1, strN-1
   read(11,*)! dummy; print *,dummy
enddo
write(13,'("Skipped to the ",i10,"nth line in ",a80)') strN,fname 
